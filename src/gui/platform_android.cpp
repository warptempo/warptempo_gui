...
// fit ceiling is 295 % since 2026-09-23 (the icon row's walk is 782 authored
// px; the arithmetic is at paint_icon_row, paint_handler.cpp, and its
// succession in git history) and anything past it crops the rightmost history
// icons. 225 CLEARS IT BY 242 LOGICAL PX.
