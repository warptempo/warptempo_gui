...
// fit ceiling is 322 % (the icon row's walk has been 714 authored px since the
// two view lamps' whole-category deletion of
// 2026-09-15; the arithmetic is at paint_icon_row, paint_handler.cpp, and its
