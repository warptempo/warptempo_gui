...
// 2026-09-26, when `fg_color` and `bg_color` replaced the core shade's two
// blend keys after sync_path for the lit plate's two-ink tuning phase; eight
// with the blend keys and seven with the one-ink `fg_color` on 2026-09-25,
// six from that day's departure of the inner compressor's two tuning keys,
// hard-coded in waveform_gain.cpp; the fuller count's succession —
...
// right after gui_scale (architect 2026-09-13), and the two ink keys after
// sync_path (architect 2026-09-26), foreground first. The scanner takes it as a
