...
public:
    ...
    // staging_path by byte-copying the disk entry file. Same confirmation
    // rules as lookup. Byte-identical to an engine publish by construction; no
    // sample conversion occurs.
