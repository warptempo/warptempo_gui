...
struct Selection {
   ...
   private:
    // THE ONE FOCUS WRITE (architect 2026-09-05): every mutator above puts
    // its focus into app.last_selected_marker through this, and nothing else
    ...
    // reached by any route but a marker press, a cell editor's open or the
    // TAB WALK's cell step is addressed at its payload by default, so
