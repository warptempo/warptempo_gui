...
void MarkerDragOps::apply_drag_motion(double raw_delta) {
    ...
    // mid-drag in any case (keys and wheels are gesture-gated, the chase is
...
// scrub instead.
//
// No drag moves the viewport (the held column is a nudge's alone, under the
// hold posture — Viewport::hold_subject_column_after_nudge).
//
