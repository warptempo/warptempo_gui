...
// Flag-editor cluster. Covers the marker lane's TWO editors — the flag's
// canonical-line editor (the warp column's alone) and the
// iteration bound editor (the warp and phase-reset columns') — the
