...
int gui_main(const char* argument) {
    ...
    // THE WAVEFORM PALETTE, the tuning phase's three inks (architect
    // 2026-09-25; the device config's `waveform_ink`, `waveform_magnified_ink`
    // and `waveform_ghost_ink`): installed ONCE here, before the first project
    ...
    // contract at waveform_palette, render.h).
