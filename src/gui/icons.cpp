...
// THE WAVEFORM MAGNIFICATION'S TWO (2026-08-26), the same family further
// along: zoom-in-y and zoom-out-y. The pair is the
...
// committed asset holds the resolved bytes, while the other is a real
// file.
