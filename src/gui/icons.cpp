...
// content: the fit frame, and the 1:1 corner-arrow dial. Both are single
// `.ColorScheme-Text` paths resolving to #fcfcfc, relative m/l/h/v with `a`
// arcs, glued negative-after-flag arc arguments ("0 0-8 8" — a flag is one
...
// zoom-in-y with the per-marker Magnification button on 2026-09-15,
// enumerators, defs and assets together.) ZOOM-OUT-Y, the vertical
// magnifier's minus, is the Ignore Waveform Magnification lamp's glyph
// (architect 2026-09-17): the same magnifier with a ruler on its dial beside
// a minus, transcribed byte-verbatim from breeze-dark's actions/22/.
