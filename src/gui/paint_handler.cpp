...
//
// THE GROUP IS NINE since 2026-09-14: the MARKER MAGNIFICATION seated right
// after the Measure (Ctrl+/, zoom-in-vertical — the glyph the retired Magnify
// button wore), the third editor opener in the run, greying as the Measure
// does and under the iteration lock.
constexpr TransportRowDef kMarkerVerbGroup[] = {
    ...
    {RedesignButton::IconMarkerMagnification, icons::Icon::ZoomInY},
...
void GuiPaintHandler::paint_bottom_row_buttons_and_clock(cairo_t* cr) {
    ...
    // GROUP IS NINE since 2026-09-14, the MARKER MAGNIFICATION joining behind
    // the Measure (eight from 2026-09-13, the VALUE DRAG LAMP leaving its
    // tail; nine from 2026-09-10, that lamp's arrival, eight from
