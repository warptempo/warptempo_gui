...
void GuiPaintHandler::paint_bottom_row_buttons_and_clock(cairo_t* cr) {
    ...
    // GROUP IS EIGHT since 2026-09-13, the VALUE DRAG LAMP leaving its tail
    // (it was nine from 2026-09-10, that lamp's arrival, eight from
    ...
    // seats it at 123 — and the right block is 526 wide since 2026-09-13
    // (270 verbs + 11 separator span + 100 walk + 11 + 134 arrows; it was 560
    // with the nine-box verb group of 2026-09-10), so it
    ...
    // authored px wide at 100% on 1920 (1142 while the lamp stood) and 398
    // logical px on the tablet's 2560 device px at 225% (364 while it stood),
    ...
    // 225% leaves 1138 logical px and 398 of clear ground. Still no collision
