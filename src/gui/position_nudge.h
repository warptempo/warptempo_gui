...
// (d) invalidate_status_row_area then invalidate_clock_area — the bottom
//     strip's TWO lanes, each named because this tail dirties both: the
//     selection readout on row 9, and the clock on row 8 through the playhead
//     move at (e);
