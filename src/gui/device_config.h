...
// ceiling (295 since 2026-09-23 — the walk's own paragraph below) are
// untouched by the move.
//
// THE LAYOUT IS NOT WIDENED WITH THE CEILING, deliberately: below roughly
// 782 px of LOGICAL width (device width divided by the factor) the icon row's
// twenty-two-button left-to-right walk runs past the window's right edge —
// the tablet's own 225 clears it by 242 (2304/2.25 = 1024 logical px) and 295
// is the fit ceiling on that panel (282 until Follow's deletion 2026-09-23), inside the [50, 350] vocabulary, so a
