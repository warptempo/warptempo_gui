...
// ceiling (308 since 2026-09-17 — the walk's own paragraph below) are
...
// the tablet's own 225 clears it by 276 (2304/2.25 = 1024 logical px) and 308
// is the fit ceiling on that panel since the IGNORE WAVEFORM MAGNIFICATION
// LAMP joined the row on 2026-09-17 (architect
// 2026-09-17), inside the [50, 350] vocabulary, so a scale above it crops (the
