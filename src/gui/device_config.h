...
// ceiling (322 since 2026-09-15 — the walk's own paragraph below) are
// untouched by the move.
//
// THE LAYOUT IS NOT WIDENED WITH THE CEILING, deliberately: below roughly
// 714 px of LOGICAL width (device width divided by the factor) the icon row's
// twenty-button left-to-right walk runs past the window's right edge —
// the tablet's own 225 clears it by 310 (2304/2.25 = 1024 logical px) and 322
// is the fit ceiling on that panel since the TWO VIEW LAMPS' WHOLE CATEGORY
// DELETION of 2026-09-15 (architect
// 2026-09-15), inside the [50, 350] vocabulary, so a scale above it crops (the
