...
// max_waveform_height (the config's other two keys have no editor:
// last_project is the program's own, and fg_color, the core ink's tuning
// phase, is hand-edited; `audio_player`, once
