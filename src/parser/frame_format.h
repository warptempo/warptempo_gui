...
// Serialization of frame positions — one domain, one pair.
//
...
// definition of the on-disk position form; every producer and
...
// (MM:SS.mmm) are display-only renderings; see time_format.h. Positions on
// a render's own target axis are computed live by the GUI and never
// serialized.
